...
These are tied up with the keyboard shortcuts, which is perhaps the only thing that require further explanation aside from the buttons to change the font size, which you will find if you move the cursor towards the top right of the editor window. 
