...
Occam does not support this language as yet but will do so in the future.
For the moment it can be created using the grammars sandbox that is one of the subjects of the next chapter:
...
Occam also allows languages to be extended by way of custom grammars.
